 ...
 * @file    ArcadeIT_SRAM_LL.h
 * @version V0.13
 * @date    26-07-2017
 * @last    27-02-2020
 * @brief   This library is used to setup the BUS to access the SRAM module.
 *
 ******************************************************************************
 TOADD
...
#ifndef _ARCADEIT_SRAM_LL_H_
#define _ARCADEIT_SRAM_LL_H_
...
#define SRAM_512K          0b0001 // bank 0 present
#define SRAM_1024K         0b0011 // banks 0,1 present
#define SRAM_2048K         0b1111 // banks 0,1,2,3 present

#define BUS_SRAM_PRESCALER 2
